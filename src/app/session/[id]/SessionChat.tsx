...
export function SessionChat({ sessionId, initialMessages, config }: SessionChatProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      {/* Sidebar */}
      <aside className={`${sidebarCollapsed ? 'w-12' : 'w-72 lg:w-80'} bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col transition-all duration-300`}>
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
          ...
          <button
            ...
            title={sidebarCollapsed ? 'Visa panel' : 'Dölj panel'}
          >
        ...
        {sidebarCollapsed ? (
          <div className="flex-1 flex flex-col items-center py-4 space-y-4">
            <Link href="/dashboard" className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg" title="Dashboard">
                  ...
                  >
                    <div
                      className={`px-4 py-3 rounded-lg whitespace-pre-wrap ${
                        message.role === 'user'
                          ? 'max-w-2xl bg-blue-600 text-white'
                          : 'max-w-4xl bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white'
                      }`}
                    >
                      {message.content || (
